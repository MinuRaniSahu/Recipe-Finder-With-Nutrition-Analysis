...
st.write("Search recipes from all over the world and get ingredients and preparation steps!")

# --- Function to fetch recipe ---
def get_recipe(dish_name):
    # Step 1: Search recipe to get ID
    ...
    recipe_id = search_data["results"][0]["id"]  # Spoonacular recipe ID
